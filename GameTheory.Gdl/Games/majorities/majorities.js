...
function renderstate (state)
 {var canvas = document.createElement('canvas');
  ...
  //drawhex(270, 20,canvas);
  //drawhex(330, 20,canvas);

  drawhex(240, 40,canvas);
  //drawhex(300, 40,canvas);
  //drawhex(360, 40,canvas);

  drawhex(210, 60,canvas);
  drawhex(270, 60,canvas);
  //drawhex(330, 60,canvas);
  //drawhex(390, 60,canvas);

  drawhex(180, 80,canvas);
  drawblack(240, 80,canvas);
  drawhex(300, 80,canvas);
  //drawhex(360, 80,canvas);
  //drawhex(420, 80,canvas);

  drawhex(150,100,canvas);
  drawhex(210,100,canvas);
  drawhex(270,100,canvas);
  drawhex(330,100,canvas);
  //drawhex(390,100,canvas);
  //drawhex(450,100,canvas);
  ...
  // drawhex(450,180,canvas);
  //drawhex(510,180,canvas);
  //drawhex(570,180,canvas);
  ...
  // drawhex( 30,220,canvas);
  // drawhex( 90,220,canvas);
  drawhex(150,220,canvas);
  drawblack(210,220,canvas);
  drawblack(270,220,canvas);
  drawhex(330,220,canvas);
  // drawhex(390,220,canvas);
  // drawhex(450,220,canvas);
  //drawhex(510,220,canvas);
  //drawhex(570,220,canvas);

  // drawhex( 60,240,canvas);
  drawhex(120,240,canvas);
  drawhex(180,240,canvas);
  drawhex(240,240,canvas);
  drawhex(300,240,canvas);
  drawhex(360,240,canvas);
  // drawhex(420,240,canvas);
  //drawhex(480,240,canvas);
  //drawhex(540,240,canvas);

  // drawhex( 90,260,canvas);
  drawblack(150,260,canvas);
  drawhex(210,260,canvas);
  drawhex(270,260,canvas);
  drawblack(330,260,canvas);
  // drawhex(390,260,canvas);
  //drawhex(450,260,canvas);
  //drawhex(510,260,canvas);
  ...
  //drawhex(480,280,canvas);

  drawhex(150,300,canvas);
  drawhex(210,300,canvas);
  drawhex(270,300,canvas);
  drawhex(330,300,canvas);
  //drawhex(390,300,canvas);
  //drawhex(450,300,canvas);

  drawhex(180,320,canvas);
  drawhex(240,320,canvas);
  drawhex(300,320,canvas);
  //drawhex(360,320,canvas);
  //drawhex(420,320,canvas);

  drawhex(210,340,canvas);
  drawhex(270,340,canvas);
  //drawhex(330,340,canvas);
  //drawhex(390,340,canvas);

  drawhex(240,360,canvas);
  //drawhex(300,360,canvas);
  //drawhex(360,360,canvas);

  //drawhex(270,380,canvas);
  //drawhex(330,380,canvas);
