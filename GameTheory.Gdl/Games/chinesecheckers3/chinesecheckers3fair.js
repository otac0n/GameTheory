...
function color (cell,state)
 {var color = compfindx('Z',seq('cell',cell,'Z'),state,seq());
  if (color=='red') {return '<img src="/ggp/games/chinesecheckers4/red.png" width="40" height="40"/>'};
  if (color=='green') {return '<img src="/ggp/games/chinesecheckers4/green.png" width="40" height="40"/>'};
  if (color=='blue') {return '<img src="/ggp/games/chinesecheckers4/blue.png" width="40" height="40"/>'};
