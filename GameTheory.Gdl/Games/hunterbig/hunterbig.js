...
function makecell (row,rownum,colnum,state)
 {var cell = row.insertCell(colnum);
  ...
  if (mark=='knight') {cell.innerHTML = '<img src="http://games.ggp.org/base/resources/images/chess/White_Knight.png" width="36" height="36"/>'};
  if (mark=='pawn') {cell.setAttribute('bgcolor','#000000'); cell.innerHTML = '&nbsp;'};
