...
function color (cell,state)
 {var color = compfindx('Z',seq('cell',cell,'Z'),state,seq());
  if (color=='red') {return '<img src="/ggp/games/chinesecheckers/red.png" width="40" height="40"/>'};
  if (color=='yellow') {return '<img src="/ggp/games/chinesecheckers/yellow.png" width="40" height="40"/>'};
  if (color=='green') {return '<img src="/ggp/games/chinesecheckers/green.png" width="40" height="40"/>'};
  if (color=='blue') {return '<img src="/ggp/games/chinesecheckers/blue.png" width="40" height="40"/>'};
  if (color=='teal') {return '<img src="/ggp/games/chinesecheckers/teal.png" width="40" height="40"/>'};
  if (color=='magenta') {return '<img src="/ggp/games/chinesecheckers/magenta.png" width="40" height="40"/>'};
  return '<img src="/ggp/games/chinesecheckers/black.png" width="40" height="40"/>'}
