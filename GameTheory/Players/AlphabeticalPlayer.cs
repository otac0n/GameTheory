...
namespace GameTheory.Players
{
    ...
    /// <summary>
    /// Implements a player that chooses the first move from its options alphabetically.
    /// </summary>
    ...
    public sealed class AlphabeticalPlayer<TGameState, TMove> : IPlayer<TGameState, TMove>
        where TGameState : IGameState<TMove>
        where TMove : IMove
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlphabeticalPlayer{TGameState, TMove}"/> class.
        /// </summary>
        /// <param name="playerToken">The token that represents the player.</param>
        public AlphabeticalPlayer(PlayerToken playerToken)
        {
