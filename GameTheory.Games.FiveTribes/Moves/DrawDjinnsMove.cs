...
namespace GameTheory.Games.FiveTribes.Moves
{
    ...
    /// <summary>
    /// Represents a move to draw the top three <see cref="Djinn">Djinns</see> from the Djinn pile.
    /// </summary>
    public sealed class DrawDjinnsMove : Move
    {
        ...
        /// <inheritdoc />
        public override IList<object> FormatTokens => FormatUtilities.ParseStringFormat(Resources.DrawDjinns, GetDrawCount(this.GameState));
