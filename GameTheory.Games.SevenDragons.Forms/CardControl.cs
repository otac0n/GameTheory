            ...
            graphics.HighQuality(() =>
            {
                ...
                switch (card)
                {
                    case ActionCard actionCard:
                        ...
                        {
                            symbolPath.AddString(symbol, new Font(font.FontFamily, rect.Height * 0.4f, font.Style, GraphicsUnit.Pixel), graphics, rect, StringFormat.GenericTypographic);
                            ...
                            textPath.AddString(text, font, graphics, new RectangleF(rect.Left, bounds.Bottom + font.Size, rect.Width, rect.Bottom - (bounds.Bottom + font.Size)), stringFormat);
