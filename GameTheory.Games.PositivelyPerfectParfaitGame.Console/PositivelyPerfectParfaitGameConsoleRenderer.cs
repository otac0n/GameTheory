...
namespace GameTheory.Games.PositivelyPerfectParfaitGame.Console
{
    ...
    {
        /// <inheritdoc />
        public override void Show(IGameState<Move> state, PlayerToken playerToken) => new Templates().RenderGameState((GameState)state, this.MakeRenderTokenWriter(state));
